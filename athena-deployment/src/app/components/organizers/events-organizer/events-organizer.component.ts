...
export class EventsOrganizerComponent implements OnInit {
  ...
  getEvents(){
    this.http.get("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/api/retorgevents").subscribe(
      res => {
        console.log(res)
        this.myEvents = res;
      },
  ...
  sendDetails(form: NgForm, _id: string){
    form.value['_id'] = _id;
    this.http.post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/api/vectorless/click-on-events", form.value).subscribe(
      res => {
