...
export class OrganizerDashboardComponent implements OnInit {
  ...
  send() {
    ...
    this.http
      .post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/uploadProfile", formData)
      .subscribe(response => {
    ...
    this.postEvents();
    this.http.post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/uploadProfile", this.uploadedFiles);
  }

  // setPath(path:string){
  //   console.log(path)
  //   this.http.post('http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/setPath',path).subscribe(res=>{
  //     console.log(res)
  //   })
  // }
  ...
  // getImage(path) {
  //   this.http.get('http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/getImage' + '?url=' + path,{ responseType:'blob'}).subscribe
  //   ((response:Blob)=>{
  //     console.log('response as blob');
  //     console.log(response);
  //      this.createImageFromBlob(response);
  ...
  postEvents() {
    ...
    return this.http.post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/uploadProfile", options);
  }
  logout() {
    this.auth.logout();
  ...
  getIP() {
    this.auth.getIPAddress().subscribe((res: any) => {
      ...
      this.http.post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/api/ip", this.ipAddress);
