...
export class AcademicsComponent implements OnInit {
  ...
  getAcademics() {
    ...
    this.http
      .post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/getAcademics", options)
      .subscribe(res => {
        console.log(res);
        this.acadlist = res;
      });
  ...
  getThisAcad(acId:any){
    this.http.post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/getSpecicifAc",{acId}).subscribe(res=>{
