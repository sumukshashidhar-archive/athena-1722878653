...
export class AchievementsComponent implements OnInit {
  ...
  adduserInterestList() {
    ...
    this.http
      .post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/abcd", formData)
      .subscribe(response => {
  ...
  onSubmit(form: NgForm) {
    ...
    console.log(frmData);
    this.http.post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/upload", frmData).subscribe(res => {
      console.log(res);
    });
    this.achService.postAchievements(Achievement).subscribe(res => {
      console.log(res);
  ...
  setAttr() {
    // console.log(File);
    // console.log(`http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/${File}`);
    // document
    //   .getElementById("i1")
    //   .setAttribute("src"", `http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/${File}`);
