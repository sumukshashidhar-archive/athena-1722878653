...
export class DashboardComponent implements OnInit {
  ...
  getInterests() {
    return this.http.get("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/interests").subscribe(res => {
  ...
  send() {
    ...
    this.http
      .post("http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/uploadProfile", frmData,options)
      .subscribe(res => {
        console.log(res);
      });
  }
