...
export class  AuthService {
  ...
  login(user: User): Observable<boolean> {
    ...
    return this.http.post<JSON>('http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/login',user)
      .pipe(
        map(res => {
    ...
    posttoken(token:JSON) {
      ...
      console.log(token)
      this.http.post('http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/dashboard', token )
  ...
  logout() {
    ...
    this.http.post('http://ec2-15-206-148-32.ap-south-1.compute.amazonaws.com:3000/logout', token).subscribe(res=>{
      console.log(res)
    })
    console.log(logout)
