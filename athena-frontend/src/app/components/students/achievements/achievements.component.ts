...
export class AchievementsComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    ...
    console.log(`http://ec2-13-126-238-105.ap-south-1.compute.amazonaws.com:3000/${File[0].name}`);
    ...
    this.link = "http://ec2-13-126-238-105.ap-south-1.compute.amazonaws.com:3000/" + `${File[0].name}`;
    console.log(this.link);
    // this.http.get(`http://ec2-13-126-238-105.ap-south-1.compute.amazonaws.com:3000/${File[0].name}`).subscribe(res=>{
    //   console.log(res)
    // })
  }
