...
let AdminDashComponent = class AdminDashComponent {
    constructor() { }
    ngOnInit() { }
};
...
let CommonsignupComponent = class CommonsignupComponent {
    constructor() { }
    ngOnInit() { }
};
...
let DiscoverComponent = class DiscoverComponent {
    ...
    onSubmit(form) {
        ...
        this.data.postSearch(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
    ...
    onSubmit1(form) {
        this.data.postUserSearch(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
...
let LoginComponent = class LoginComponent {
    constructor(cookieService, formBuilder, Auth, router, loginService, data) {
...
let EventsOrganizerComponent = class EventsOrganizerComponent {
    ...
    onSubmit(form) {
        this.eventService.postEvents(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
...
EventsOrganizerComponent.ctorParameters = () => [
...
var decoded;
let OrganizerDashboardComponent = class OrganizerDashboardComponent {
    constructor(auth, router, data, uname) {
        this.auth = auth;
        this.router = router;
        this.data = data;
        this.uname = uname;
    ...
    ngOnInit() {
        ...
        console.log(decoded);
        this.data.currentName.subscribe((res) => {
...
OrganizerDashboardComponent.ctorParameters = () => [
...
let SignupOrganizerComponent = class SignupOrganizerComponent {
    constructor(organizeruserService, userService, router, _formBuilder) {
    ...
    onSubmit(form) {
        this.organizeruserService.postOrgUser(form.value).subscribe(res => {
            this.showSuccessmessage = true;
            setTimeout(() => (this.showSuccessmessage = false), 3000);
            this.router.navigate(["/login"]);
...
SignupOrganizerComponent.ctorParameters = () => [
...
let PasscheckComponent = class PasscheckComponent {
    constructor(passService, router, answerService, newPass) {
    ...
    onSubmit(form) {
        ...
        this.passService.postEmail(form.value).subscribe(res => {
            this.x = res;
        }, err => {
            if (err.status === 422) {
                console.log(422);
    ...
    onsubmit(form) {
        ...
        console.log(form.value);
        this.answerService.postAnswer(form.value).subscribe(res => {
            console.log(res);
            this.y = res;
            if (res) {
                console.log(res);
...
PasscheckComponent.ctorParameters = () => [
...
let ResetpassComponent = class ResetpassComponent {
    constructor(_formBuilder, newPass) {
        this._formBuilder = _formBuilder;
        this.newPass = newPass;
        this.isLinear = false;
    }
    ...
    onSubmit(form) {
        ...
        this.newPass.postPassword(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
...
let SearchresComponent = class SearchresComponent {
...
SearchresComponent.ctorParameters = () => [
...
let AchievementsComponent = class AchievementsComponent {
    constructor(achService, router, http, auth) {
...
AchievementsComponent.ctorParameters = () => [
...
let BigeventsComponent = class BigeventsComponent {
    constructor(eventService) {
        this.eventService = eventService;
...
BigeventsComponent.ctorParameters = () => [
    { type: _shared_events_event_service__WEBPACK_IMPORTED_MODULE_3__["EventService"] }
];
...
let DashboardComponent = class DashboardComponent {
    constructor(auth, router, data, uname, datasharingService, http, ach) {
        this.auth = auth;
        this.router = router;
        this.data = data;
        this.uname = uname;
    ...
    getImage(path) {
        this.http.get('http://localhost:3000/getImage' + '?url=' + path, { responseType: 'blob' }).subscribe((response) => {
    ...
    onSubmit(form) {
        this.datasharingService.postSearch(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
...
let EventsComponent = class EventsComponent {
    ...
    sendDetails(form, _id) {
        form.value['_id'] = _id;
        console.log(form.value);
        this.eventService.getEventDetails(form.value).subscribe(res => {
            console.log(res);
...
let SignupComponent = class SignupComponent {
    constructor(userService, router, _formBuilder) {
        this.userService = userService;
        this.router = router;
        this._formBuilder = _formBuilder;
        this.isLinear = false;
...
let Signup2Component = class Signup2Component {
    // interest: string;
    // interests = [];
    constructor(interestsendingservice, auth) {
    ...
    onSubmit(form) {
        bio = (form.value['bio']);
        console.log(bio);
        this.interestsendingservice.postInterest(form.value).subscribe(res => {
            console.log("Auth is successful");
            console.log(res);
        }, err => {
            console.log("ERROR");
...
let KeyaddComponent = class KeyaddComponent {
    constructor(Auth, http, keyaddService) {
        this.Auth = Auth;
        this.http = http;
    ...
    onSubmit(form) {
        this.keyaddService.postKey(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
...
KeyaddComponent.ctorParameters = () => [
    { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
let KeyaddService = class KeyaddService {
    constructor(http) {
        this.http = http;
        this.selectedUser = {
            username: "",
...
let RunmoduleComponent = class RunmoduleComponent {
    constructor(keyaddService) {
        this.keyaddService = keyaddService;
    }
    ngOnInit() {
    }
    onSubmit(form) {
        this.keyaddService.postModule(form.value).subscribe(res => {
            console.log(res);
        }, err => {
            if (err.status === 422) {
                console.log(422);
...
RunmoduleComponent.ctorParameters = () => [
...
AchievementsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let InterestSendingService = class InterestSendingService {
    constructor(http) {
        this.http = http;
        this.selectedInt = {
            interests: "",
...
InterestSendingService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
...
let NewpassService = class NewpassService {
    constructor(http) {
        this.http = http;
        this.selectedPass = {
            email: "",
...
let OrganizeruserService = class OrganizeruserService {
    constructor(http) {
        this.http = http;
        this.selectedUser = {
            OrganizerName: "",
...
OrganizeruserService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
DatasharingService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
...
let TokenInterceptorService = class TokenInterceptorService {
    ...
    intercept(req, next) {
        let authService = this.injector.get(_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]);
...
let UserprofileComponent = class UserprofileComponent {
    constructor(auth, router, http, achService) {
        this.auth = auth;
        this.router = router;
        this.http = http;
        this.achService = achService;
