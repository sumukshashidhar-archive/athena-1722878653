...
} from './../../../shared/organizeruser/organizeruser.service';
import {
  UserService
...
export class SignupOrganizerComponent implements OnInit {
  ...
  constructor(public organizeruserService: OrganizeruserService, public userService: UserService, private router: Router, private _formBuilder: FormBuilder) {}
